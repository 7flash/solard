...
import { HeliusSender, HttpRpcSender, sol } from "../index.js";
import { loadSolardRuntimeConfig, resolveRpcUrl } from "../solard/config.js";
...
export function installWebTradeSenders(sowl: any): void {
