import { listProcessStatus, upsertProcessStatus } from "@solard/core/db.js";
import { clearWorkerErrors } from "../db/terminal-ingestion.ts";
import { processMeasure, summarizeForMeasure } from "../measure.ts";
import bgrun, {
