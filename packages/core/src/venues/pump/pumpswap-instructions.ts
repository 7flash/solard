...
import { anchorDiscriminator, optionBool, u64 } from "./anchor.ts";
import {
  ammCreatorVaultPda,
...
import { ensureAtaIx } from "./pump-instructions.ts";
 ...
 * instruction for `slrd buy ... --sol <amount>` and for script budgets: the
